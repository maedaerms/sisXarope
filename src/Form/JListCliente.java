 ...
 * @author maeda
 */
public class JListCliente extends javax.swing.JDialog {

    /**
     * Creates new form JCadCliente
     */
    public JListCliente(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
    ...
    private void initComponents() {
        ...
        tabela.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Código", "Nome", "RG", "CPF", "Endereço", "Sexo", "Nascimento"
            }
        ) {
        ...
        jLabel1.setText("Localizar Nome:");
    ...
    private void jBtnFiltroActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnFiltroActionPerformed
        ...
        model.setNumRows(0);
        for (Object c : dao.getAll(jTextField1.getText()))
        {
            Cliente cliente = (Cliente) c;
            model.addRow(new Object[]
            {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JListCliente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JListCliente dialog = new JListCliente(new javax.swing.JFrame(), true);
