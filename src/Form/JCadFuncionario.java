 ...
 * @author maeda
 */
public class JCadFuncionario extends javax.swing.JDialog {

    /**
     * Creates new form JCadCliente
     */
    public JCadFuncionario(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
    ...
    public JCadFuncionario(JDialog parent, boolean modal) {
        super(parent, modal);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JCadFuncionario dialog = new JCadFuncionario(new javax.swing.JFrame(), true);
