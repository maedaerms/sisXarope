 ...
 * @author maeda
 */
public class JListFuncionario extends javax.swing.JDialog {

    /**
     * Creates new form JCadCliente
     */
    public JListFuncionario(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
    ...
    private void initComponents() {
        ...
        jLabel5.setText("Listagem de Funcionários");
        ...
        tabela.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Código", "Nome", "RG", "CPF", "Endereço", "Sexo", "Cargo", "Salario", "Nascimento", "Admissao"
            }
        ) {
    ...
    private void jBtnNovoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnNovoActionPerformed
        // TODO add your handling code here:
        JCadFuncionario jcf = new JCadFuncionario(this, true);
    ...
    private void jBtnFiltroActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnFiltroActionPerformed
        ...
        model.setNumRows(0);
        for (Object f : dao.getAll(jTxtNome.getText()))
        {
            Funcionario funcionario = (Funcionario) f;
            model.addRow(new Object[]
            {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JListFuncionario.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JListFuncionario dialog = new JListFuncionario(new javax.swing.JFrame(), true);
