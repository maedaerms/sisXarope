 ...
 * @author maeda
 */
public class JAltCategoria extends javax.swing.JDialog {

    /**
     * Creates new form JCadCliente
     */
    public JAltCategoria(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
    ...
    public JAltCategoria(JDialog parent, boolean modal) {
        super(parent, modal);
    ...
    private void initComponents() {
        ...
        jLabel5.setText("Alterar Categoria");
    ...
    private void jBtnAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnAlterarActionPerformed
        ...
        DAO dao = new DAOCategoria();
        
        if(dao instanceof DAO)
        {
            Categoria categoria = new Categoria();

            categoria.setId(Integer.parseInt(jTxtCodigo.getText()));
    ...
    private void jBtnExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnExcluirActionPerformed
        // TODO add your handling code here:
        new DAOCategoria().remover(Integer.parseInt(jTxtCodigo.getText()));
        this.limparCampos();
    ...
    private void jTxtCodigoKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTxtCodigoKeyReleased
        ...
        {
            Categoria c = (Categoria) new DAOCategoria().getPorID(Integer.parseInt(jTxtCodigo.getText()));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JAltCategoria.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JAltCategoria dialog = new JAltCategoria(new javax.swing.JFrame(), true);
